...
from quad4 import quad4_post, quad4_line_load
...
for nn in natural_nodes:
    ...
    #print(f" xy = {xy}")
    ke,fe = quad4_line_load(xy,properties_load, ni, nj)
...
write_node_data_2("Q4/disp.msh" , nodes, uv[:,0],uv[:,1] , "Despl")
...
write_node_data("Q4/sxx.msh", nodes, σxx, "Sigma_x")
write_node_data("Q4/syy.msh", nodes, σyy, "Sigma_y")
write_node_data("Q4/sxy.msh", nodes, σxy, "Sigma_xy")
